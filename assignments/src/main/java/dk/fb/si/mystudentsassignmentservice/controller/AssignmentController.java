package dk.fb.si.mystudentsassignmentservice.controller;
...
import dk.fb.si.mystudentsassignmentservice.exceptions.AssignmentNotFoundException;
import dk.fb.si.mystudentsassignmentservice.repository.AssignmentRepository;
...
public class AssignmentController
{
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateStudent(@RequestBody Assignment assignment, @PathVariable long id)
    {
